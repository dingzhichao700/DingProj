...
var game;
(function (game) {
    var LoginInputView = (function (_super) {
        ...
        /** 创建完成*/
        LoginInputView.prototype.createCompleteEvent = function (event) {
            var self = this;
            self.isLoad = true;
        ...
        LoginInputView.prototype.onDestroy = function () {
            var self = this;
    ...
    game.LoginInputView = LoginInputView;
    __reflect(LoginInputView.prototype, "game.LoginInputView");
})(game || (game = {}));
//# sourceMappingURL=LoginInputView.js.map