...
var SkillVmcView = (function (_super) {
    __extends(SkillVmcView, _super);
    function SkillVmcView() {
    ...
    /** 创建完成*/
    SkillVmcView.prototype.createCompleteEvent = function (event) {
        var self = this;
        self.isLoad = true;
    ...
    SkillVmcView.prototype.onDestroy = function () {
        var self = this;
...
__reflect(SkillVmcView.prototype, "SkillVmcView");
//# sourceMappingURL=SkillVmcView.js.map