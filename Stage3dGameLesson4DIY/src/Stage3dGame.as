			...
			for (looptemp = 0; looptemp < 4; looptemp++) {
				...
				switch (looptemp) {
					case 0:
						...
						modelMatrix.appendTranslation(-3, 2.8 + ((t % 20) > 10? 0.2 : 0), 0);
						break;
					case 1:
		...
		private function initData():void {
			...
			meshVertexData = Vector.<Number>([
				//X, Y, Z,  U,V,  nX,nY,nZ	   r,   g,   b,   a
				 -1,-1, 0,  0, 0,  0, 0, 1,  0.3, 0.1, 0.3, 1.0, // 四个点都呈现暗紫色
				  1,-1, 0,  1, 0,  0, 0, 1,  0.3, 0.1, 0.3, 1.0,
				  1, 1, 0,  1, 1,  0, 0, 1,  0.3, 0.1, 0.3, 1.0,
				 -1, 1, 0,  0, 1,  0, 0, 1,  0.3, 0.1, 0.3, 1.0
			]);
		}
	}
}
